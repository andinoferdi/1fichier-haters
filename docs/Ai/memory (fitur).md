...
- Repo: `1fichier-haters` | Path lokal: `C:\Users\Lenovo\Downloads\1fichier-haters`.
...
## Kontrak Interface / Signal - FINAL
Kunci kontrak yang tidak boleh berubah tanpa keputusan baru. Project ini tanpa API HTTP, jadi kontrak biasanya berupa signature worker, signal/slot PyQt5, atau format file config.

```text
[SIGNAL_ATAU_METHOD] [MODUL_ATAU_CLASS]
Thread/lock terkait: [NAMA]
```
...
2. Periksa `git status` pada repo `1fichier-haters`.
